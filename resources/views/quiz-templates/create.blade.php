        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <!-- Back Button -->
                    <div class="mb-6">
                        <a href="{{ route('quiz-templates.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                    ...
                    <form method="POST" action="{{ route('quiz-templates.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" autocomplete="description">{{ old('description') }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="total_questions" name="total_questions" type="number" class="mt-1 block w-full" min="1" max="50" required />
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4 mt-2">
                                <div>
                                    ...
                                    <x-text-input id="mcq_count" name="mcq_count" type="number" class="mt-1 block w-full" min="0" required />
                                    <x-input-error class="mt-2" :messages="$errors->get('mcq_count')" />
                                </div>
                                <div>
                                    <x-input-label for="fill_blank_count" :value="__('Fill Blank')" />
                                    <x-text-input id="fill_blank_count" name="fill_blank_count" type="number" class="mt-1 block w-full" min="0" required />
                                    <x-input-error class="mt-2" :messages="$errors->get('fill_blank_count')" />
                                </div>
                                <div>
                                    <x-input-label for="code_count" :value="__('Code')" />
                                    <x-text-input id="code_count" name="code_count" type="number" class="mt-1 block w-full" min="0" required />
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4 mt-2">
                                <div>
                                    ...
                                    <x-text-input id="difficulty_distribution_easy" name="difficulty_distribution[easy]" type="number" class="mt-1 block w-full" min="0" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="difficulty_distribution_medium" name="difficulty_distribution[medium]" type="number" class="mt-1 block w-full" min="0" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="difficulty_distribution_hard" name="difficulty_distribution[hard]" type="number" class="mt-1 block w-full" min="0" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="time_limit" name="time_limit" type="number" class="mt-1 block w-full" min="1" max="300" />
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="is_public" name="is_public" type="checkbox" value="1" {{ old('is_public') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
