            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('question-banks.store') }}">
                        ...
                        <div class="mb-4">
                            <x-input-label for="questions_per_quiz" :value="__('Questions per Quiz')" />
                            <x-text-input id="questions_per_quiz" class="block mt-1 w-full" type="number" name="questions_per_quiz" :value="old('questions_per_quiz', 10)" min="1" max="50" required />
                            <x-input-error :messages="$errors->get('questions_per_quiz')" class="mt-2" />
                        </div>
