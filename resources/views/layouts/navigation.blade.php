    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <ul class="flex items-center gap-4  text-gray-500 text-sm font-medium ">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>Welcome, {{ Auth::user()->name ?? 'Guest'}}</div>
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('userAttemptedQuiz',auth()->user()->name)">
                            User Quiz Attempts
                        </x-dropdown-link>
